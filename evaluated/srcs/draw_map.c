...
/*   Updated: 2020/01/08 15:44:41 by spentti          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_xy(t_dot *dot, int *x, int *y, t_info *info)
{
	int z;
...
static t_xy	*make_xy(t_dot *dot, int mode, t_info *info)
{
	int		x;
	t_dot	*temp;
...
static void	draw_background(void *mlx_ptr, void *win_ptr, int color)
{
	int	x;
	int y;
